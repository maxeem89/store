                        ...
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <div class="table-responsive table-desi">
                                    <form class="needs-validation" action="{{route('dashboard.categories.update', $category->id)}}"
                                               ...
                                               <select name="parent_id" id ="" class="form-control">
                                                 ...
                                                 @foreach($mainCategories as $mainCategory)
                                                     @if($mainCategory->id != $category->id)
                                                       <option value="{{$mainCategory->id}}" @if($mainCategory->parent_id == $category->parent_id) selected
